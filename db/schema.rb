...
ActiveRecord::Schema.define(version: 20161226215804) do

  create_table "games", force: :cascade do |t|
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.integer  "board_size",        default: 9, null: false
  ...
  create_table "hexagons", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_id"], name: "index_hexagons_on_game_id"
    t.index ["user_id"], name: "index_hexagons_on_user_id"
  end
